...
HOST=$HOST PORT=$PORT KEEPALIVE=$KEEPALIVE CLEAN_SESSION=$CLEAN_SESSION TOPIC=$TOPIC MQTT_USER=$MQTT_USER MQTT_PASSWORD=$MQTT_PASSWORD DIRECTORY=$DIRECTORY ${BIN_PATH}/bin/sendat
}
